...
export const CATEGORY_COLORS: Record<string, string> = {
  "Office Supplies": "bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-200",
  ...
  "Meals & Entertainment": "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-300",
  ...
  "Salaries": "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300",
  ...
  "Shipping": "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300",
  "Advertising": "bg-fuchsia-100 text-fuchsia-800 dark:bg-fuchsia-900/30 dark:text-fuchsia-300",
  ...
  "Transportation": "bg-lime-100 text-lime-800 dark:bg-lime-900/30 dark:text-lime-300",
  "Other": "bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-400",
};

export const DEPARTMENT_COLORS: Record<string, string> = {
  "Sales & Marketing": "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300",
  ...
  "Human Resources": "bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300",
